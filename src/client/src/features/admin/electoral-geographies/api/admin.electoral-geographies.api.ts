...
import {
    ADMIN_ELECTORAL_GEOGRAPHY_ENDPOINTS
} from "@/features/admin/electoral-geographies/api/admin.electoral-geographies.endpoints.ts";
import type {
    AddDistrictRequest, AddMunicipalityRequest,
    AddProvinceRequest, AddVotingPlaceRequest, AddWardRequest,
    DistrictInfo, MunicipalityInfo,
    ProvinceInfo, UpdateDistrictRequest, UpdateMunicipalityRequest, UpdateProvinceRequest, UpdateVotingPlaceRequest,
    UpdateWardRequest, VotingPlaceInfo, WardInfo
...
export const AdminElectoralGeographyApi = {
    ...
    getVotingPlacesByWardId: async (
        wardId: number
    ): Promise<VotingPlaceInfo[]> =>
        apiClient.get(
            ADMIN_ELECTORAL_GEOGRAPHY_ENDPOINTS.GET_VOTING_PLACES_BY_WARDS_ID(
                wardId
            )
        ),
    ...
    addProvince: async (
        request: AddProvinceRequest
    ): Promise<ProvinceInfo> =>
        apiClient.post(
            ADMIN_ELECTORAL_GEOGRAPHY_ENDPOINTS.ADD_PROVINCE,
            request
        ),

    addDistrict: async (
        request: AddDistrictRequest
    ): Promise<DistrictInfo> =>
        apiClient.post(
            ADMIN_ELECTORAL_GEOGRAPHY_ENDPOINTS.ADD_DISTRICT,
            request
        ),
    ...
    addWard: async (
        ...
        apiClient.post(
            ADMIN_ELECTORAL_GEOGRAPHY_ENDPOINTS.ADD_WARD,
            request
        ),
    ...
    updateMunicipality: async (
        ...
        apiClient.put(
            ADMIN_ELECTORAL_GEOGRAPHY_ENDPOINTS.UPDATE_MUNICIPALITY(
                municipalityId
            ),
            request
        ),
    ...
    updateVotingPlace: async (
        ...
        apiClient.put(
            ADMIN_ELECTORAL_GEOGRAPHY_ENDPOINTS.UPDATE_VOTING_PLACE(
                votingPlaceId
            ),
            request
        ),
