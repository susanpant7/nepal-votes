...
export const AdminPoliticalPartiesTable = (props: PoliticalPartiesTableProps) => {
    return (
        <div className="w-full space-y-6">
            {/* Header Section with more padding */}
            <div className="flex items-center justify-between px-1">
                <div className="space-y-1">
                    <h2 className="text-3xl font-bold tracking-tight text-foreground">Political Parties</h2>
                                        ...
                                        <div className="relative">
                                            <Avatar className="h-12 w-12 border border-border/50 shadow-sm transition-transform group-hover:scale-105">
                                                ...
                                                <AvatarFallback className="text-xs font-bold">
                                                    {party.politicalPartyName.substring(0, 2).toUpperCase()}
                                                </AvatarFallback>
                                            </Avatar>
                                        </div>
                                    </TableCell>
